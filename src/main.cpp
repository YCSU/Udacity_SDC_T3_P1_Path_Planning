      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Create widely spaced (x, y) waypoints
            vector<double> ptsx;
            vector<double> ptsy;
            ...
            // values to be used for the planner
            ...
            // fill up 50 points for the planner
            for( int i = 0; i < 50 - prev_size; ++i ){
              ...
              double x_veh= x_point;
              double y_veh = y_point;

              //transform back to world map
              x_point = x_veh * cos(ref_yaw) - y_veh * sin(ref_yaw) + ref_x;
              y_point = x_veh * sin(ref_yaw) + y_veh * cos(ref_yaw) + ref_y;
